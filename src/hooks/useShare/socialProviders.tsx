...
export const SOCIAL_PROVIDERS = {
    ...
    facebook: {
        ...
        shareUrl: (config: ShareConfig) => `https://www.facebook.com/sharer/share.php?u=${encodeURIComponent(config.url)}`
    },
    slack: {
        name:'Slack',
    ...
    threads: {
        ...
        shareUrl: (config: ShareConfig) => `https://threads.net/intent/post?text=${encodeURIComponent(`${config.title || ''} ${config.url}`)}`
    }
}
