...
export const PostCard = ({ slug, title, description, image, date, author } : PostCardProps) => {
    return (
        <Link href={`/blog/${slug}`} className="w-full max-w-2xl rounded-[12px] border-[1px] border-gray-400 bg-gray-600 overflow-hidden transition-all duration-3000 hover:border[1px] hover:border-blue-300">
            {/* Post Content */}
            <div className="p-2 rounded-md overflow-hidden">
                ...
                <div className="px-2 mt-4 space-y-4">
                    ...
                    {/* "line-clamp-3" serve para delimitar o campo e colocar reticências no final. */}
