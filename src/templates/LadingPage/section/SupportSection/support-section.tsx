...
export const SupportSection = () => {
    return(
        <section className="relative pb-8 md:py-10 bg-gray-700">
            <div className="absolute inset-0 hidden md:block bg-[url('/background-features.svg')] bg-cover bg-center bg-no-repeat opacity-35" />
            <div className="container flex flex-col items-center gap-12 relative">
                ...
                <div className="grid grid-6 md:grid-cols-3 gap-4">
                    {/* Primeiro card */}
                    ...
                    <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
                        ...
                        <strong className="text-heading-sm text-gray-100">Venda em qualquer loja</strong>
                        <p className="text-body-sm text-gray-200">Não importa a loja, o Site.Set permite que você insira qualquer link de afiliação.</p>
                    </div>
                     {/* terceiro card */}
                    <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
                        <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-300 mb-4">
                        ...
                        <p className="text-body-sm text-gray-200">Nossa equipe estará sempre pronta para ajudar no que for preciso.</p>
                    </div>
                </div>
            </div>
        </section>
